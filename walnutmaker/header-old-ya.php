...
<head>
	...
	<script src="/wp-content/themes/walnutmaker/js/yamap.js" type="text/javascript"></script>
			...
			<div class="container">
				<div class="wt-header-wrap">
								...
								<div class="wt-header-logo">
									<?php
										echo $_SERVER[ 'REQUEST_URI' ] != '/' ? '<a href="' . esc_url( home_url() ) .
											'" rel="home">' : '';
										//echo wt_logo();
										echo '<img src="'.wt_logo( 'header_logo', true )[0].'" class="attachment-full size-full" alt="" loading="lazy">';
					...
					<div class="wt-header-action">
						<a data-src="#wt-modal-callback" href="javascript:" class="callback-open">
