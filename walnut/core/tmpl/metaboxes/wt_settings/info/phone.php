<div>
	...
	! $data['href'] ? 'style="display: none;"' : ''; ?>>
		<input type="hidden" name="phone[title]" class="link-title"
			value="<?php echo isset( $data['title'] ) ? htmlspecialchars( $data['title'] ) : ''; ?>"/>
		<input type="hidden" name="phone[href]" class="link-href"
			value="<?php echo isset( $data['href'] ) ? $data['href'] : ''; ?>"/>
		<input type="hidden" name="phone[target]" class="link-target"
		...
		<span class="dashicons dashicons-edit btn-link" data-id="link-phone"></span>
		<span class="dashicons dashicons-no"></span>
	</div>
	<div class="link-add" <?php echo isset( $data ) && isset( $data['href'] ) && $data['href'] ?
		'style="display: none;"' : ''; ?>>
		<p>
			<?php _ex( 'Phone is not specified', 'Label of link', 'walnut' ); ?>
			<a href="#" class="button btn-link" data-id="link-phone"><?php _ex( 'Insert link', 'Text for button',
					'walnut' ); ?></a>
		</p>
	</div>
</div>