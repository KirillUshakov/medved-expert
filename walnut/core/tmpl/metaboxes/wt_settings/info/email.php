<div>
	...
	! $data['href'] ? 'style="display: none;"' : ''; ?>>
		<input type="hidden" name="email[title]" class="link-title"
			value="<?php echo isset( $data['title'] ) ? htmlspecialchars( $data['title'] ) : ''; ?>"/>
		<input type="hidden" name="email[href]" class="link-href"
			value="<?php echo isset( $data['href'] ) ? $data['href'] : ''; ?>"/>
		<input type="hidden" name="email[target]" class="link-target"
		...
		<span class="dashicons dashicons-edit btn-link" data-id="link-email"></span>
		<span class="dashicons dashicons-no"></span>
	</div>
	<div class="link-add" <?php echo isset( $data ) && isset( $data['href'] ) && $data['href'] ?
		'style="display: none;"' : ''; ?>>
		<p>
			<?php _ex( 'E-mail is not specified', 'Label of link', 'walnut' ); ?>
			<a href="#" class="button btn-link" data-id="link-email">
				<?php _ex( 'Insert link', 'Text for button', 'walnut' ); ?>
			</a>
		</p>
	</div>
</div>