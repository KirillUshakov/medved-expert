<div class="wrap wp_theme_settings">
	<h1><?php _ex( 'Multiple Upload Photos', 'Title on upload page', 'walnut' ); ?></h1>
	...
	<form method="post" enctype="multipart/form-data"
		...
		?>
		<div id="poststuff" class="multiple-upload">
			<div id="post-body"
	...
	(function( $ ) {
		$( document ).ready( function() {
			...
			$( '.upload-photos' ).on( 'click', function( e ) {
				e.preventDefault();
				renderMediaUploader( $( this ).parent().siblings( '.uploaded-mediafiles' ), true, 'photos', 'image', 'image' );
			} );
