<div class="wrap wt_theme_settings">
	<h1><?php _ex( 'Theme settings', 'Title on page', 'walnut' ); ?></h1>
	
	<form name="wt_theme_settings" method="post" enctype="multipart/form-data"
	      action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI'] ); ?>">
		<?php
			settings_fields( 'header_logo' );
			settings_fields( 'footer_logo' );
			settings_fields( 'favicon' );
			settings_fields( 'wt_theme_settings' );
