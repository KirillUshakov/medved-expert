<div class="wrap wp_theme_settings">
	<h1><?php _ex( 'Gallery Settings', 'Title on settings page', 'walnut' ); ?></h1>
		...
		<div id="poststuff" class="testimonials">
			<div id="post-body"
				...
				<div id="postbox-container-2" class="postbox-container">
					<?php do_meta_boxes( $this->pagesettings, 'normal', null ); ?>
					<!-- Here is a content after normal meta boxes and before advanced meta boxes -->
					<?php do_meta_boxes( $this->pagesettings, 'advanced', null ); ?>
				</div>
			</div>
		</div>
		<div class="clear"></div>
